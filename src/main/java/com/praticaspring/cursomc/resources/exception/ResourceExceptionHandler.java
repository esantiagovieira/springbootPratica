package com.praticaspring.cursomc.resources.exception;
...
import com.praticaspring.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		ValidationError err = new ValidationError(System.currentTimeMillis(), HttpStatus.UNPROCESSABLE_ENTITY.value(), "Data Validation", e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<StandardError> AmazonS3Exception(com.amazonaws.services.s3.model.AmazonS3Exception e, HttpServletRequest request) {
